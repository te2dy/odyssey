...
class OrigineMiniUtils
{
    ...
    public static function origineMiniSocialIcons($icon = '')
    {
        $social_svg = [
            ...
            'peertube' => '<path d="M12 6.545v10.91L20.727 12M3.273 12v12L12 17.455M3.273 0v12L12 6.545"/>',
...
class OrigineMiniSettings
{
    ...
    {
        return [
            '500px'    => __('site-name-500px'),
            'diaspora' => __('site-name-diaspora'),
            'discord'  => __('site-name-discord'),
            'facebook' => __('site-name-facebook'),
            'github'   => __('site-name-github'),
            'mastodon' => __('site-name-mastodon'),
            'peertube' => __('site-name-peertube'),
            'signal'   => __('site-name-signal'),
            'telegram' => __('site-name-telegram'),
            'tiktok'   => __('site-name-tiktok'),
            'twitter'  => __('site-name-twitter'),
            'vimeo'    => __('site-name-vimeo'),
            'whatsapp' => __('site-name-whatsapp'),
            'youtube'  => __('site-name-youtube')
        ];
    }
}
