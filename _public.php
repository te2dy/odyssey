...
class tplOrigineMiniTheme
{
     ...
     * Dotclear and theme versions are shown only on dev environment.
     *
     * @return void
     */
    ...
    public static function origineMiniPostDate()
    {
        ...
        return '<?php echo "<time aria-label=\"{{tpl:lang post-date-aria-label}}\" class=\"post-date text-secondary\" datetime=\"" . \dcCore::app()->ctx->posts->getDate("%Y-%m-%dT%H:%m", "creadt") . "\">" . \dcCore::app()->ctx->posts->getDate("' . $format_date . '", "creadt")' . $post_time . ' . "</time>"; ?>';
    }
