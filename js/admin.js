...
function socialSites() {
  return ['bluesky', 'diaspora', 'email', 'facebook', 'instagram', 'mastodon', 'matrix', 'phone', 'signal', 'sms', 'telegram', 'youtube', 'whatsapp', 'x', 'other'];
}
...
function disableInputs() {
  ...
  if (document.getElementById("header_image-preview")) {
    setStyle("header_image_as_title", "block");
