...
function disableInputs() {
  ...
  if (document.getElementById("header_banner").value !== "") {
    document.getElementById("header_banner_position-input").style.display = "block";
  } else {
    document.getElementById("header_banner_position-input").style.display = "none";
  }
...
function changeImage() {
  if (document.getElementById("header_banner").value !== "") {
    document.getElementById("header_banner-src").removeAttribute("style");
    document.getElementById("header_banner-src").setAttribute("src", encodeURI(document.getElementById("header_banner").value));
  } else {
    document.getElementById("header_banner-src").style.display = "none";
  }
}
